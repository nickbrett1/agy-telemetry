...
A lightweight telemetry integration for the Google Antigravity (`agy`) CLI that exports chat logs, metadata, and tool executions as OpenTelemetry traces to an [Arize Phoenix](https://github.com/Arize-ai/phoenix) telemetry server.
